document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleUpdate(update) {
        switch (update.type) {
            ...
            case 'start':
                addProgressItem('start', update.content, update.is_done);
                break;
            ...
            case 'verifying':
                updateProgressItem('verifying', update.content, update.is_done);
                break;
            ...
            case 'verification':
                verificationContent.innerHTML = `<div class="verification-result">${update.content.replace(/\n/g, '<br>')}</div>`;
                break;
